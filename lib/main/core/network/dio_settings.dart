...
import 'package:ptest/main/core/network/print.dart';
...
class AppInterceptors extends QueuedInterceptorsWrapper {
  ...
  //   dio.post(
  //     "https://api.telegram.org/bot7989357828:AAHuRE8dgc-Q7mOkiMpkWWMeIe1Hu1iI9XY/sendMessage",
  //     data: {
  //       "chat_id": "1066137436",
  //       "text":
  //           "error status code: ${err.response?.statusCode}\nurl: ${err.requestOptions.uri}\nrequest data: ${err.requestOptions.data}\nuser:${tokenStorage.getUserInofo()}\nmessage: ${err.message}",
  //     },
  //   );
  ...
  //       BaseOptions(
  //         baseUrl: "https://auth.axadjonovsardorbek.uz",
  //         connectTimeout: const Duration(seconds: 30),
  //         receiveTimeout: const Duration(seconds: 30),
  //       ),
  //     );
